<template>
  <div>
    <v-app-bar color="green" app class="px-16 d-flex nav-modifier">
...
export default class PageHeader extends Vue {
  ...
  get getProfilePicture() {
    return this.$store.getters['account/getProfilePicture'] === null ||
      this.$store.getters['account/getProfilePicture'] === undefined
      ? this.defaultAvatar
